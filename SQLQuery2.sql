...
CREATE PROC ThemBD(@MAHS CHAR(10),@MAMON CHAR(15),@HOCKY CHAR(10),@DIEMMIENG FLOAT,@DIEM15P FLOAT,@DIEM1TIET FLOAT,@DIEMHOCKY FLOAT) AS
BEGIN
	 INSERT INTO dbo.BANGDIEM
	 VALUES  (@MAHS,@MAMON,@HOCKY,@DIEMMIENG,@DIEM15P,@DIEM1TIET,@DIEMHOCKY) 
END
go
ThemBD '01','TRR','2',9,9,9,9

CREATE PROC SuaBD (@MAHS CHAR(10),@MAMON CHAR(15),@HOCKY CHAR(10),@DIEMMIENG FLOAT,@DIEM15P FLOAT,@DIEM1TIET FLOAT,@DIEMHOCKY FLOAT) AS
BEGIN
...
END
GO
CREATE PROC XoaBD(@MAHS CHAR(10),@MAMON CHAR(15)) AS
 BEGIN
